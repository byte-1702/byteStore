...
// Prefijo para enlaces internos cuando la página vive en nbproject/admin/
$scriptFile = (string) ($_SERVER['SCRIPT_FILENAME'] ?? '');
$navBase = '';
if ($scriptFile !== '' && basename(dirname($scriptFile)) === 'admin') {
    $navBase = '../';
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars($navBase . '../CSS/global.css', ENT_QUOTES, 'UTF-8'); ?>">
