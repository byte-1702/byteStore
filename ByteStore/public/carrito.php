    ...
    <div class="home-hero__content">
        ...
        <div class="home-hero__actions">
            ...
            <?php if (isset($_SESSION['user'])): ?>
                <a class="home-btn home-btn--ghost" href="confirmacion_pago.php">Ir a checkout</a>
            <?php else: ?>
        ...
        <div class="home-grid cart-grid">
            ...
            <article class="home-card cart-checkout-card">
                ...
                <?php else: ?>
                    ...
                    <?php if (isset($_SESSION['user'])): ?>
                        <a class="home-btn home-btn--primary cart-checkout-btn" href="confirmacion_pago.php">Ir a confirmar compra</a>
                    <?php else: ?>
                        <a class="home-btn home-btn--primary cart-checkout-btn" href="login.php">Iniciar sesion para pagar</a>
                    <?php endif; ?>
